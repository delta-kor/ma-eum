  ...
  return (
    <div className="relative">
      <div
        ...
        className="relative aspect-[1536/1279] w-full overflow-hidden bg-gradient-to-b from-[#20A1EC_30%] sm:!mt-0 sm:aspect-auto sm:h-[320px] md:h-[430px] lg:h-[500px] xl:h-[540px]"
      >
        <picture>
