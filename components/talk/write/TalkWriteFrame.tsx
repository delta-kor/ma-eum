        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-12 rounded-16 border-2 border-gray-100 p-20 md:max-w-[480px]">
            <input
              maxLength={100}
              name="poll-title"
              placeholder={i18n('$talk_poll_title_placeholder', language)}
              type="text"
            ...
            <div className="flex flex-col gap-8">
              {options.map((data, index) => (
                <div
                  key={data}
                  className="flex items-center gap-8 rounded-8 bg-gray-50 px-16 py-14"
                >
                  <input
                    maxLength={50}
              ...
              >
                ...
                <div className="select-none text-16 font-500 text-gray-200">
                  <Translate>$talk_poll_add_option</Translate>
                </div>
              </div>
            </div>
          </div>
          <div className="text-14 font-400 text-gray-500">
            <Translate>$talk_poll_cannot_be_edited</Translate>
          </div>
        </div>
      )}
      {!isEditMode && (
        <div className="flex items-center">
          ...
          >
            ...
            <div className="select-none text-16 font-500 text-gray-500">
              <Translate>{isPollActive ? '$talk_poll_remove' : '$talk_poll'}</Translate>
            </div>
          </div>
        </div>
      )}
