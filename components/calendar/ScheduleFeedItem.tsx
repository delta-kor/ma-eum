...
export default function ScheduleFeedItem({ schedule }: Props) {
  return (
    <div className="flex cursor-pointer items-center gap-8 rounded-16 border-3 border-white bg-gradient-to-r from-white from-20% to-primary-200 px-24 py-16 shadow-primary-slated lg:border-none lg:bg-gray-100 lg:from-gray-50 lg:to-gray-50 lg:shadow-transparent">
