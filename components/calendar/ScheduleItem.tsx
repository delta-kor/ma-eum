export default function ScheduleItem() {
  return (
    <div className="flex cursor-pointer items-center gap-4 rounded-16 border-3 border-white bg-gradient-to-r from-white from-20% to-primary-200 px-24 py-16 shadow-primary">
