...
export default function AlertModal({ modal, onResolve }: Props) {
  return (
    <div className="mx-auto flex max-w-[480px] flex-col gap-8 rounded-16 bg-white p-24">
      <div className="text-20 font-600 text-black">알림</div>
      ...
      <div
        ...
        className="-mb-16 -mt-12 flex cursor-pointer items-center justify-center rounded-8 p-16 text-16 font-600 text-primary-500"
      >
